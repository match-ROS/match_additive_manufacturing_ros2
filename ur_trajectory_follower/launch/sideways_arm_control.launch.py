    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[{
                ...
                'control_mode': LaunchConfiguration('direction_control_mode'),
        ...
        Node(
            ...
            parameters=[
                PathJoinSubstitution([FindPackageShare('ur_trajectory_follower'), 'config', 'pid_twist_controller.yaml']),
                {
                    ...
                    'Kp_linear_x': LaunchConfiguration('Kp_linear_x'),
                    'Ki_linear_x': LaunchConfiguration('Ki_linear_x'),
                    'Kd_linear_x': LaunchConfiguration('Kd_linear_x'),
                    'Kp_linear_y': LaunchConfiguration('Kp_linear_y'),
                    'Ki_linear_y': LaunchConfiguration('Ki_linear_y'),
                    'Kd_linear_y': LaunchConfiguration('Kd_linear_y'),
                    'Kp_linear_z': LaunchConfiguration('Kp_linear_z'),
                    'Ki_linear_z': LaunchConfiguration('Ki_linear_z'),
                    'Kd_linear_z': LaunchConfiguration('Kd_linear_z'),
                    'Kp_angular_x': LaunchConfiguration('Kp_angular_x'),
                    'Ki_angular_x': LaunchConfiguration('Ki_angular_x'),
                    'Kd_angular_x': LaunchConfiguration('Kd_angular_x'),
                    'Kp_angular_y': LaunchConfiguration('Kp_angular_y'),
                    'Ki_angular_y': LaunchConfiguration('Ki_angular_y'),
                    'Kd_angular_y': LaunchConfiguration('Kd_angular_y'),
                    'Kp_angular_z': LaunchConfiguration('Kp_angular_z'),
                    'Ki_angular_z': LaunchConfiguration('Ki_angular_z'),
                    'Kd_angular_z': LaunchConfiguration('Kd_angular_z'),
                },
            ],
        ),
        Node(
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('Kp_linear_x', default_value='1.0'),
        DeclareLaunchArgument('Ki_linear_x', default_value='0.0'),
        DeclareLaunchArgument('Kd_linear_x', default_value='0.0'),
        DeclareLaunchArgument('Kp_linear_y', default_value='1.0'),
        DeclareLaunchArgument('Ki_linear_y', default_value='0.0'),
        DeclareLaunchArgument('Kd_linear_y', default_value='0.0'),
        DeclareLaunchArgument('Kp_linear_z', default_value='1.0'),
        DeclareLaunchArgument('Ki_linear_z', default_value='0.0'),
        DeclareLaunchArgument('Kd_linear_z', default_value='0.0'),
        DeclareLaunchArgument('Kp_angular_x', default_value='1.0'),
        DeclareLaunchArgument('Ki_angular_x', default_value='0.0'),
        DeclareLaunchArgument('Kd_angular_x', default_value='0.0'),
        DeclareLaunchArgument('Kp_angular_y', default_value='1.0'),
        DeclareLaunchArgument('Ki_angular_y', default_value='0.0'),
        DeclareLaunchArgument('Kd_angular_y', default_value='0.0'),
        DeclareLaunchArgument('Kp_angular_z', default_value='1.0'),
        DeclareLaunchArgument('Ki_angular_z', default_value='0.0'),
        DeclareLaunchArgument('Kd_angular_z', default_value='0.0'),
        DeclareLaunchArgument('from_index_offset', default_value='-1'),
        DeclareLaunchArgument('goal_index_offset', default_value='0'),
        DeclareLaunchArgument('direction_control_mode', default_value='goal_direction'),
