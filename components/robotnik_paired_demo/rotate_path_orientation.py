...
# Rotation of -90° around local X-axis
angle = -math.pi / 2.0
q_rot = [
    math.sin(angle / 2.0),  # x
    0.0,                    # y
    0.0,                    # z
    math.cos(angle / 2.0),  # w
]

input_file = "match_additive_manufacturing_ros2/components/robotnik_paired_demo/arm_path.json"
output_file = "match_additive_manufacturing_ros2/components/robotnik_paired_demo/arm_path_rotated.json"
