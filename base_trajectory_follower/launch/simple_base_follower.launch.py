...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('smooth_velocity_commands', default_value='true'),
        DeclareLaunchArgument('max_accel_x', default_value='0.25'),
        DeclareLaunchArgument('max_accel_y', default_value='0.25'),
        DeclareLaunchArgument('max_accel_wz', default_value='0.5'),
        Node(
            ...
            parameters=[
                LaunchConfiguration('config_file'),
                {
                    ...
                    'smooth_velocity_commands': LaunchConfiguration('smooth_velocity_commands'),
                    'max_accel_x': LaunchConfiguration('max_accel_x'),
                    'max_accel_y': LaunchConfiguration('max_accel_y'),
                    'max_accel_wz': LaunchConfiguration('max_accel_wz'),
                },
            ],
        ),
    ])
