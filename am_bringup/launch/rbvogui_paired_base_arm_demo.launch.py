...
def generate_launch_description():
    ...
    prestart_path_publisher = Node(
        ...
        parameters=[{
            ...
            'arm_base_offset': LaunchConfiguration('arm_base_offset'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('arm_base_offset', default_value='[0.26, 0.0, 1.046]'),
        ...
        DeclareLaunchArgument('arm_tip_link', default_value='robot_arm_nozzle_tip'),
