...
def generate_launch_description():
    ...
    arm_control = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'start_base_motion_compensation': LaunchConfiguration('start_base_motion_compensation'),
            'base_velocity_topic': LaunchConfiguration('base_velocity_topic'),
            'base_velocity_type': LaunchConfiguration('base_velocity_type'),
            'base_compensation_topic': LaunchConfiguration('base_compensation_topic'),
            'base_compensation_stale_timeout': LaunchConfiguration('base_compensation_stale_timeout'),
            'base_compensation_smoothing_coeff': LaunchConfiguration('base_compensation_smoothing_coeff'),
        }.items(),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            ...
            default_value='true',
            description='Compensate TCP motion induced by the moving platform during paired arm tracking.',
        ),
        DeclareLaunchArgument('base_velocity_topic', default_value='/robot/robotnik_base_control/odom'),
