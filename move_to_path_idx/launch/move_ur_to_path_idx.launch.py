...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('max_linear_acceleration', default_value='0.10'),
        DeclareLaunchArgument('max_linear_jerk', default_value='0.40'),
        DeclareLaunchArgument('max_angular_acceleration', default_value='0.30'),
        DeclareLaunchArgument('max_angular_jerk', default_value='1.20'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'max_linear_jerk': LaunchConfiguration('max_linear_jerk'),
                'max_angular_acceleration': LaunchConfiguration('max_angular_acceleration'),
                'max_angular_jerk': LaunchConfiguration('max_angular_jerk'),
